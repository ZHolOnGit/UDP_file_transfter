...
static MunitResult test_send_file_with_timeout_empty(
    const MunitParameter params[], void* fixture);
static MunitResult test_send_file_with_timeout(const MunitParameter params[], 
    void* fixture);
...
static MunitTest tests[] = {
    { "/test_send_file_with_timeout_empty", test_send_file_with_timeout_empty, 
        NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { "/test_send_file_with_timeout", test_send_file_with_timeout, 
        NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
...
static const MunitSuite suite = {
    "/test_rftcu_send_file_with_timeout", tests, NULL, 1,
...
static MunitResult test_send_file_with_timeout_empty(
    ...
    assert_int(send_file_with_timeout(&proto), ==, PS_EMPTY_FILE);
...
static proto_state run_client(pid_t ppid, uint16_t port) {
    ...
    proto_state ps = send_file_with_timeout(&proto);
